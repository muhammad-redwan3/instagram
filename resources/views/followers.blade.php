                    ...
                    <div class="flex flex-col mb-3">
                        <div class="flex flex-row justify-rounded">
                            <div class="flex flex-row">
                                <a href="/{{$follower->username}}" class="rounded-full h-10 w-10 mr-3">
                                ...
                                <div class="flex flex-col self-center">
                                    ...
                                    <h3 class="text-sm text-gray-500 truncate whitespace-nowarp" style="max-width:25ch">{{$follower->bio}}</h3>
                                </div>
                            </div>
