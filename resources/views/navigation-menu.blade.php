    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center" >
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <div><h1 style="font-family: Norican" class="text-3xl">{{__('instagram mu')}}</h1></div>
                    </a>
                </div>
                ...
                <div>
                    <input type="search" placeholder="search" class="border boder-gary-300 text-center boder-bold">
                </div>
